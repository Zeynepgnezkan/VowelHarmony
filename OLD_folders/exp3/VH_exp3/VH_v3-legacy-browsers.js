...
function anketRoutineBegin(snapshot) {
  return async function () {
    ...
    anketComponents.forEach( function(thisComponent) {
...
function StudypracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    StudypracticeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function InstractionRoutineBegin(snapshot) {
  return async function () {
    ...
    InstractionComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
